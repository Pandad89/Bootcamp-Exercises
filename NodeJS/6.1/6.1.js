const data = [
  ...
  const food = (arr) => {
    ...
    // The forEach method was being implemented on an object instead of on an array.
    // To fix this, I've changed the code to run a forEach method on the meats array
    // inside of the food object. 
