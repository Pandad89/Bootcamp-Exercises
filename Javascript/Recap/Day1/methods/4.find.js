...
function greaterThan(num){
    const great = numbers.find(arr => arr > num);
    return great;
};
...
function fruitName (str) {
    const fruit = inventory.find(arr => arr === str);
    return fruit;
};

console.log(fruitName("apples"));
//3
const movies = [
    {
      id: 1,
  ...
  function idFind(num) {
    const findById = movies.find(obj => obj.id === num)
  }
